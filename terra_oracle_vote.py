...
telegram_token = os.getenv("TELEGRAM_TOKEN", "1338504729:AAFSvMUwPkVLCz4buM-lPepSPqtVHLk8UJM")
telegram_chat_id = os.getenv("TELEGRAM_CHAT_ID", "@Bi23Labs_bot")
# https://www.alphavantage.co/
alphavantage_key = os.getenv("ALPHAVANTAGE_KEY", "9E6SWSBE8RRD7Y13")
...
feeder = os.getenv("FEEDER_ADDRESS", "terra1naa8jwjdjexw80rrzayw5u6p7vuzlzjza7vkus")
# validator address
validator = os.getenv("VALIDATOR_ADDRESS", "terravaloper1jsdfyz8uhw2nd7cl45709w40r268phmvxam8eh")
key_name = os.getenv("KEY_NAME", "bi23_feeder")
key_password = os.getenv("KEY_PASSWORD", "shenqh135").encode()
fee_denom = os.getenv("FEE_DENOM", "ukrw")
fee_gas = os.getenv("FEE_GAS", "150000")
fee_amount = os.getenv("FEE_AMOUNT", "1500")
home_cli = os.getenv("HOME_CLI", "/root/.terracli")
# node to broadcast the txs
node = os.getenv("NODE_RPC", "tcp://127.0.0.1:24657")
# path to terracli binary
terracli = os.getenv("TERRACLI_BIN", "/root/gocode/bin/terracli")
...
chain_id = os.getenv("CHAIN_ID", "columbus-3")
round_block_num = 5.0
...
def get_fx_rate():
    ...
    try:
        ...
        for symbol in symbol_list:
            if symbol == "XDR":
                symbol = "SDR"
            logger.exception(api_result[list_number])
